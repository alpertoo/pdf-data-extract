...
def main():
    ...
    # Get Evri fuel surcharge from extras
    evri_fuel_total = get_evri_fuel_total(evri_extras)

    # Metrics
    fedex_metrics = compute_fedex_metrics(fedex_df, fixed_rate_fedex)
    evri_metrics = compute_evri_metrics(evri_despatch, fixed_rate_evri, fuel_total=evri_fuel_total)
